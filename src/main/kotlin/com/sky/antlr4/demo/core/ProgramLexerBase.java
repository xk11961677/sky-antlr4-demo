...
import com.sky.antlr4.demo.parser.ProgramLexer;
 ...
 */
public abstract class ProgramLexerBase extends Lexer
{
    /**
    ...
    public ProgramLexerBase(CharStream input) {
        super(input);
    }
    ...
    {
        if (lastToken == null || lastToken.getType() == ProgramLexer.OpenBrace)
        {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            case ProgramLexer.Identifier:
            case ProgramLexer.NullLiteral:
            case ProgramLexer.BooleanLiteral:
            case ProgramLexer.This:
            case ProgramLexer.CloseBracket:
            case ProgramLexer.CloseParen:
            case ProgramLexer.OctalIntegerLiteral:
            case ProgramLexer.DecimalLiteral:
            case ProgramLexer.HexIntegerLiteral:
            case ProgramLexer.StringLiteral:
            case ProgramLexer.PlusPlus:
            case ProgramLexer.MinusMinus:
